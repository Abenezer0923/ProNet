            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div className="relative pl-8 border-l-2 border-gray-100 space-y-8">
                    <div className="relative">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-gray-900">{profile.profession || 'Add your position'}</h3>
                            <p className="text-gray-600 font-medium">Current Company</p>
                            <p className="text-sm text-gray-500 mt-1">Jan 2023 - Present · 1 yr</p>
                            <p className="text-sm text-gray-500">{profile.location || 'Location'}</p>
                            <p className="mt-3 text-gray-600 leading-relaxed">
                                Describe your role and responsibilities here. This helps others understand your experience.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div className="flex gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">Start Year - End Year</p>
                        </div>
                    </div>
                </div>
            </div>
